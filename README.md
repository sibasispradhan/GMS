...
Demo admin login id: sibasis and password: sibasis

<b>Receptionist</b> - The gym receptionist plays a crucial role in creating a positive experience for gym members and ensuring that gym operations run smoothly. Receptionist can view contact details of everyone, add a member, delete a member.

Demo receptionist login id: recep1 and password: 1234
...
Demo member login id: member1 and password: 1234
...
Demo trainer login id: tranier1 and password: 1234
